...
const NavBar: React.FC<NavBarProps> = ({ title, logoutUser, isAuthenticated }) => {
...
const NavLinks: React.FC<{ logoutUser: () => void; isAuthenticated: () => boolean }> = ({ logoutUser, isAuthenticated }) => (
  <>
