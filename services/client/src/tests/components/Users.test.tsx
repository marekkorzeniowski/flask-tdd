...
describe("Users", () => {
  ...
  it("Should render no registered users when there are no users passed to the component", () => {
    render(<Users users={[]} onAddUser={mockOnAddUser} removeUser={mockRemoveUser}  isAuthenticated={false}/>); // Pass isAuthenticated={false}
  ...
  it("Should render user details when users are passed to the component", () => {
    ...
    render(<Users users={mockUsers} onAddUser={mockOnAddUser} removeUser={mockRemoveUser} isAuthenticated={true}/>); // Pass isAuthenticated={true}
  ...
  it("Should call onAddUser when Add User button is clicked", () => {
    render(<Users users={[]} onAddUser={mockOnAddUser} removeUser={mockRemoveUser} isAuthenticated={true}/>); // Pass isAuthenticated={true}
